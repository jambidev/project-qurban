...
const galleryItems: GalleryItem[] = [
  {
    id: "sapi-bali",
    title: "Sapi Bali",
    description: "Sapi Bali berkualitas tinggi dari peternakan kami.",
    thumbnail:
      "https://images.unsplash.com/photo-1570042225831-d98fa7577f1e?w=800&q=80",
    images: [
      "https://images.unsplash.com/photo-1570042225831-d98fa7577f1e?w=1200&q=90",
      "https://images.unsplash.com/photo-1584552641827-facce9854c17?w=1200&q=90",
      "https://images.unsplash.com/photo-1545468259-3061b2e1c97b?w=1200&q=90",
      "https://images.unsplash.com/photo-1599447292180-45fd84092ef0?w=1200&q=90",
    ],
  },
  {
    id: "sapi-bali-premium",
    title: "Sapi Bali Premium",
    description: "Sapi Bali premium dengan kualitas terbaik.",
    thumbnail:
      "https://images.unsplash.com/photo-1584935358346-2d43b1d158ce?w=800&q=80",
    images: [
      "https://images.unsplash.com/photo-1584935358346-2d43b1d158ce?w=1200&q=90",
      "https://images.unsplash.com/photo-1527153857715-3908f2bae5e8?w=1200&q=90",
      "https://images.unsplash.com/photo-1575467678930-c7acd65d6470?w=1200&q=90",
    ],
  },
  {
    id: "sapi-lokal",
    title: "Sapi Lokal",
    description: "Sapi lokal dengan kualitas terjamin.",
    thumbnail:
...
const GallerySapiPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-24 bg-white">
      <h1 className="text-3xl font-bold text-center mb-8">Galeri Sapi</h1>
          ...
          <div className="relative w-full max-w-4xl mx-auto animate__animated animate__zoomIn">
            ...
            <div className="relative flex items-center justify-center h-[70vh] md:h-[80vh]">
              <img
                ...
                className="max-w-full max-h-full object-contain mx-auto animate__animated animate__fadeIn"
              />
...
export default GallerySapiPage;
