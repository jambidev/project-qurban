        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400 mb-4">
              Penyedia hewan qurban berkualitas sejak 1993. Menyediakan sapi dan
              kambing dengan kondisi prima, sehat, dan sesuai syariat.
            </p>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">
                  Jl. Ibrahim Ripin No.2, Kenali Asam Bawah, Kec. Kota Baru,
              ...
              <li className="flex items-center">
                <Phone size={20} className="text-primary mr-3 flex-shrink-0" />
                <a
                  href="https://wa.me/6281366653939"
                  className="text-gray-400 hover:text-primary transition-colors duration-300"
                >
